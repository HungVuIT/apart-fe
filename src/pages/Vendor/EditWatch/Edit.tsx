...
function Edit({ product }: IProps) {
  ...
  const [lstFile, setLstFile] = useState<any[]>([
    null,
    null,
    null,
    null,
  ...
  const [isHome, setIsHome] = useState(product.isHome);
  const refList = {
  ...
  const setInitValueProduct = () => {
    if (product) {
      ...
      product?.isHome && setIsHome(product.isHome ? 1 : 0);
      product?.CID && setValue("CID", product.CID);
  ...
  const handeChangeCategory = (event: SelectChangeEvent) => {
    const selectedBrand = event.target.value;
    setValue("CID", +selectedBrand);
  };
  const onSubmit: SubmitHandler<IDataNewWatch> = async (
    _data: IDataNewWatch
  ) => {
  ...
  return (
    <form
      ...
      className={classes.wrapper + " new-watch"}
    >
      <Container className={classes.container}>
        <>
          ...
          <div className={classes.item}>
            ...
            <div
              className={classes["item-content"] + " " + classes["img-group"]}
            >
              <div
                className={classes["item-img"]}
                onClick={() => handleClickUpload(refList.ref1)}
              >
                {!!lstImg[0] && (
                  <img
                    src={lstImg[0]}
                    alt="Avatar"
                    className={classes["img-avt"]}
                  />
                )}
                <input
                  type="file"
              ...
              <div
                className={classes["item-img"]}
                onClick={() => handleClickUpload(refList.ref2)}
              >
                {!!lstImg[1] && (
                  <img
                    src={lstImg[1]}
              ...
              <div
                className={classes["item-img"]}
                onClick={() => handleClickUpload(refList.ref3)}
              >
                {!!lstImg[2] && (
                  <img
                    src={lstImg[2]}
              ...
              <div
                className={classes["item-img"]}
                onClick={() => handleClickUpload(refList.ref4)}
              >
                {!!lstImg[3] && (
                  <img
                    src={lstImg[3]}
              ...
              <div
                className={classes["item-img"]}
                onClick={() => handleClickUpload(refList.ref5)}
              >
                {!!lstImg[4] && (
                  <img
                    src={lstImg[4]}
              ...
              <div
                className={classes["item-img"]}
                onClick={() => handleClickUpload(refList.ref6)}
              >
                {!!lstImg[5] && (
                  <img
                    src={lstImg[5]}
        ...
        <>
                  ...
                  <FormControl fullWidth className={classes.select}>
                    ...
                    >
                      {categoryAndBrand.categories.length > 0 &&
                        categoryAndBrand.categories.map((item) => (
          ...
          <div className={classes.group + " group"}>
                      ...
                      <FormControl fullWidth className={classes.select}>
                        ...
                        >
                          {categoryAndBrand.brands.length > 0 &&
                            categoryAndBrand.brands.map((item) => (
                              <MenuItem key={item.id} value={item.id}>
                                {item.name}
                              </MenuItem>
                            ))}
            ...
            <div className={classes.groupRight}>
              ...
              <div className={classes.itemGroup}>
                <div className={classes["itemGroup-title"]}>Loại sản phẩm</div>
                <div className={classes["itemGroup-content"]}>
                  <FormControl fullWidth className={classes.select}>
                    <Select
                      labelId="demo-simple-select-label"
                      ...
                      onChange={(e) => {
                        ...
                        setValue("isHome", !!e.target.value);
                        // !e.target.value && setValue('', '');
                      }}
                    >
                      <MenuItem value={1}>Thiết kế</MenuItem>
                      <MenuItem value={0}>Sản phẩm bản lẻ</MenuItem>
                    </Select>
                  </FormControl>
                </div>
              </div>
              {/* {
                !!isHome && <div className={classes.itemGroup}>
      ...
      <div className={classes.groupBtn}>
        <Button
          ...
          onClick={() => navigate("/shop/manager/watch")}
        >
          Hủy
        </Button>
        <Button
