...
function NewProduct() {
  ...
  const onSubmit: SubmitHandler<IDataNewProduct> = async (
    _data: IDataNewProduct
  ) => {
  ...
  return (
    <form
      ...
      className={classes.wrapper + " new-product"}
    >
      <Container className={classes.container}>
        <>
          ...
          <div className={classes.item}>
            <div className={classes["item-title"]}>*Giá chính xác</div>
            <div className={classes["item-content"]}>
              <Controller
                name="price"
                control={control}
          ...
          <div className={classes.item}>
            <div className={classes["item-title"]}>*Giá ước lượng</div>
            <div className={classes["item-content"]}>
              <Controller
                name="estimatedPrice"
                control={control}
